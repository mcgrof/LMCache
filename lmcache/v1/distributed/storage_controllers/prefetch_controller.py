...
class PrefetchController(StorageControllerInterface):
    ...
    def _discard_reserved(self, keys: list[ObjectKey]) -> None:
        ...
        uninitialized buffers for an L2 store (B8) racing the delete;
    ...
    def _finalize_load(self, request: InFlightPrefetchRequest) -> None:
        ...
        if loaded_keys:
            if request.mode is PrefetchMode.WARM:
                ...
                # pipeline for already-stored keys (B7/B31).
        ...
        # uninitialized buffer for an L2 store (B8).
        if failed_keys:
